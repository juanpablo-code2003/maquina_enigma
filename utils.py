CARACTERES_ASCII = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890?:.;,!’"()#$%&/[]+*\'-_~<>£'
...
CONEXIONES_ENG_ROTOR_3 = [1, 3, 5, 7, 9, 11, 2, 15, 17, 19, 21, 23, 25, 13, 24, 4, 8, 22, 6, 0, 10, 12, 20, 18, 16, 14]
CONEXIONES_ENG_REFLECTOR = [24, 17, 20, 7, 16, 18, 11, 3, 15, 23, 13, 6, 14, 10, 12, 8, 4, 1, 5, 25, 2, 22, 21, 9, 0, 19]
